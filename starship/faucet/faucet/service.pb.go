...
var file_faucet_service_proto_rawDesc = string([]byte{
	...
	0x72, 0x65, 0x64, 0x69, 0x74, 0x42, 0x7a, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x61, 0x75,
	...
	0x68, 0x79, 0x70, 0x65, 0x72, 0x77, 0x65, 0x62, 0x2d, 0x69, 0x6f, 0x2f, 0x73, 0x74, 0x61, 0x72,
	0x73, 0x68, 0x69, 0x70, 0x2f, 0x66, 0x61, 0x75, 0x63, 0x65, 0x74, 0xa2, 0x02, 0x03, 0x46, 0x58,
	0x58, 0xaa, 0x02, 0x06, 0x46, 0x61, 0x75, 0x63, 0x65, 0x74, 0xca, 0x02, 0x06, 0x46, 0x61, 0x75,
	0x63, 0x65, 0x74, 0xe2, 0x02, 0x12, 0x46, 0x61, 0x75, 0x63, 0x65, 0x74, 0x5c, 0x47, 0x50, 0x42,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x06, 0x46, 0x61, 0x75, 0x63, 0x65,
	0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_faucet_service_proto_rawDescOnce sync.Once
	file_faucet_service_proto_rawDescData []byte
)

func file_faucet_service_proto_rawDescGZIP() []byte {
	file_faucet_service_proto_rawDescOnce.Do(func() {
		file_faucet_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_faucet_service_proto_rawDesc), len(file_faucet_service_proto_rawDesc)))
	})
	return file_faucet_service_proto_rawDescData
}

var file_faucet_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_faucet_service_proto_goTypes = []any{
...
func file_faucet_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_faucet_service_proto_rawDesc), len(file_faucet_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,

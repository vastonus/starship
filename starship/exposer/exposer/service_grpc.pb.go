...
const (
	...
	Exposer_GetGenesisSSZ_FullMethodName         = "/exposer.Exposer/GetGenesisSSZ"
	Exposer_GetConfigFile_FullMethodName         = "/exposer.Exposer/GetConfigFile"
...
func (c *exposerClient) GetGenesisSSZ(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ResponseFileData, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResponseFileData)
	err := c.cc.Invoke(ctx, Exposer_GetGenesisSSZ_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Exposer_GetGenesisSSZ_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExposerServer).GetGenesisSSZ(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Exposer_GetGenesisSSZ_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExposerServer).GetGenesisSSZ(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _Exposer_GetConfigFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExposerServer).GetConfigFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Exposer_GetConfigFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExposerServer).GetConfigFile(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Exposer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetGenesisSSZ",
			Handler:    _Exposer_GetGenesisSSZ_Handler,
		},
		{
			MethodName: "GetConfigFile",
			Handler:    _Exposer_GetConfigFile_Handler,
		},
		{
			MethodName: "GetKeys",
